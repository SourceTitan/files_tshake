...
if result.id_ then 
local keko2 = database:get('tshake:'..bot_id.."keko:name"..result.id_)
if not result.first_name_ then 
if keko2 then 
send(msg.chat_id_, msg.id_, 1, "يولد هذا غير اسمه لك ها كلب "..keko2, 1, 'html')
database:del('tshake:'..bot_id.."keko:name"..result.id_) 
end
end
...
database:set('tshake:'..bot_id.."keko:name"..result.id_, result.first_name_) 
end
end
end
